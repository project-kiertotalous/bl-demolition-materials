...
//Runko ja levy (kg), lasi (kg)
  ...
  class FloorStructuresAndMaterialsWeights {
    ...
    static num treeTrunks50x100mm600mmDivision1_6LmPerSqmKgPerSqm = 1.6 * WoodMaterialInfo.weightPerLinearMeter(WoodMaterialType.trunkWood50x100);
  ...
  class FurnitureDressingKitchenToiletSpaceWeights {
    ...
    static num woodBasedClosetsAndOtherFurnitureWidth06MKgPerLinearMeter = woodBasedClosetsAndOtherFurnitureWidth06MKgPerPcs / 0.6;
